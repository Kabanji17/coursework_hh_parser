...
def test_add_vacancy():
    return Vacancy(
        "Python Developer", "<https://hh.ru/vacancy/123456>", "100000 - 500000", "Требования: опыт работы от 3 лет..."
    )
...
def vacancy_2():
    return Vacancy(
        "Python Developer", "<https://hh.ru/vacancy/123456>", "110000 - 160000", "Требования: опыт работы от 3 лет..."
    )
